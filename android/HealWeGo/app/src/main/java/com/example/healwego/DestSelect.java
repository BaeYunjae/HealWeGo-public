...
public class DestSelect extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayout = findViewById(R.id.layout_select_dest);
        ...
        myLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCurrentLocatiion != null) {
                    ...
                    Toast.makeText(DestSelect.this, "현재 위치를 사용할 수 없습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( DestSelect.this, REQUIRED_PERMISSIONS,
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DestSelect.this);
